...
uint256 hashGenesisBlock("0xc474fbacc56e58a0d4b29a5137ced3282b2eba8bb1d0a3095c6b7f7b847c9d7e");
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // ClcCoin: 1 days
static const int64 nTargetSpacing = 120; // ClcCoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal clccoin miner
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "This is the Artificial Intelligence CPCCATTLE coin";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1478113189; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1496743;

        if (fTestNet)
        {
            block.nTime    = 1478113189;
            block.nNonce   = 1496743;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x3e8575b3049b370149513d13cd525257e6c407fc47b96f2bee4dcfd3aae11e25"));
